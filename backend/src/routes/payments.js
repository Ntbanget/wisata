...
router.post('/upload-proof', authenticate, uploadPayment.single('payment_proof'), PaymentController.uploadPaymentProof);
...
router.get('/:id/proof', authenticate, adminOnly, PaymentController.getPaymentProof);
